...
contract NFTMarketGasOptimization is ReentrancyGuard, Ownable {
     ...
     */
    function updateFeePercentage(uint16 newFeePercentage) external onlyOwner {
        require(newFeePercentage <= 1000, "NFTMarket: fee percentage too high");
        uint16 oldPercentage = feePercentage;
